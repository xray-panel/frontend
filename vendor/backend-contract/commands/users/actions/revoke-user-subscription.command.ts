        ...
        z.object({
            ...
            shortUuid: z.optional(
                z
                    ...
                    .max(64)
                    .describe(
                        'Optional. If not provided, a new short UUID will be generated by XPANEL. Please note that it is strongly recommended to allow XPANEL to generate the short UUID.',
                    ),
            ),
        }),
    );
